describe(`TC-PBI20-BOARD-VISIBILITY-1-FE\n 
    ...
    beforeEach(()=> {
        ...
        cy.wait(100)
        cy.visit('/board/CvsV0YFJhE')  // <------ add your board id here
    }) ;
    ...
    it(`[Step 2.4] Should no open /board/:id/task/add page and 
        ...
        cy.visit('/board/CvsV0YFJhE/task/add') // <------ add your board id here
    ...
    it(`[Step 2.5] Should no open /board/:id/task/:task-id/edit page and 
        ...
        cy.visit('/board/CvsV0YFJhE/task/180/edit') // <------ add your board id and task id here
    ...
    it(`[Step 2.6] Should no open /board/:id/status/add page and 
        ...
        cy.visit('/board/CvsV0YFJhE/status/add') // <------ add your board id here
    ...
    it(`[Step 2.7] Should no open /board/:id/status/:status-id/edit page and 
        ...
        cy.visit('/board/CvsV0YFJhE/status/406/edit') // <------ add your board id and status id here
